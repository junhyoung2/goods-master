...
const ItemPage = ({ onAddCart, likedItems, toggleLike }) => {
    ...
    const isLiked =
        product && likedItems?.some((item) => item.id === product.id);
                ...
                <div className="left">
                    ...
                    <div className="qna-list">
                        ...
                        <div className="Qmenu-list">
                            ...
                            >
                                배송{" "}
                                <button>{openQna.delivery ? "▲" : "▼"}</button>
                            </div>
                            {openQna.delivery && (
                                <ul className="Qmenu-content">
                                    ...
                                    <li>
                                        배송지 수정 방법: 결제완료, 상품준비중
                                        단계에서는 마이페이지 → 주문내역 →
                                        더보기 → 정보수정으로 변경 가능합니다.
                                        <br />
                                        배송중 단계는 수정이 불가능하며, 문의
                                        채널을 통해 미수령 반품 문의 바랍니다.
                                    </li>
                                </ul>
                            )}
                        </div>
                        ...
                        <div className="Qmenu-list">
                            <div
                                className="Qmenu-header"
                                onClick={() => toggleQna("return")}
                            >
                                교환/반품/주문취소{" "}
                                <button>{openQna.return ? "▲" : "▼"}</button>
                            </div>
                            {openQna.return && (
                                <ul className="Qmenu-content">
                                    <li>
                                        주문취소: 결제완료, 상품 준비중 단계에서
                                        가능하며, 환불은 1~2일 내 처리됩니다.
                                    </li>
                                    <li>
                                        단순변심 교환/반품: 수령 후 7일 이내
                                        가능하나, 사용 또는 파손 시 불가합니다.
                                        <br />
                                        환불은 검수 후 2~3일 소요됩니다.
                                    </li>
                                    <li>
                        ...
                        <div className="Qmenu-list">
                            <div
                                className="Qmenu-header"
                                onClick={() => toggleQna("group")}
                            >
                                단체 주문{" "}
                                <button>{openQna.group ? "▲" : "▼"}</button>
                            </div>
                            {openQna.group && (
                                <ul className="Qmenu-content">
                                    <li>
                                        동일 굿즈 10개 이상 주문 시 단체
                                        주문입니다.
                                        <br />
                                        단체 주문 할인은 ‘단체 주문 할인 쿠폰’을
                                        적용해주세요.
                                        <br />
                        ...
                        <div className="Qmenu-list">
                            <div
                                className="Qmenu-header"
                                onClick={() => toggleQna("etc")}
                            >
                                기타 문의{" "}
                                <button>{openQna.etc ? "▲" : "▼"}</button>
                            </div>
                            {openQna.etc && (
                                <ul className="Qmenu-content">
                                    <li>
                                        제품 색감 차이: 모니터(RGB)와
                                        출력물(CMYK) 간 색상 차이 있을 수
                                        있습니다.
                                    </li>
                                    <li>
                                        계좌 등록 오류 시:
